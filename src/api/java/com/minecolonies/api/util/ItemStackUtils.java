...
public final class ItemStackUtils
{
    ...
    public static boolean hasToolLevel(@Nullable final ItemStack stack, final IToolType toolType, final int minimalLevel, final int maximumLevel)
    {
        ...
        final int level = (Compatibility.isTinkersWeapon(stack) ||  Compatibility.isTinkersLongRangeWeapon(stack)) ? Compatibility.getToolLevel(stack) : getMiningLevel(stack, toolType);
    ...
    public static boolean isTool(@Nullable final ItemStack itemStack, final IToolType toolType)
    {
        ...
        {
            isATool = itemStack.getItem() instanceof ItemBow  || Compatibility.isTinkersLongRangeWeapon(itemStack);
        }
        else if (ToolType.SWORD.equals(toolType))
        {
    ...
    {
        return stack.getItem() instanceof ItemSword || stack.getItem() instanceof ItemTool || Compatibility.isTinkersWeapon(stack)  || Compatibility.isTinkersLongRangeWeapon(stack);
    }
